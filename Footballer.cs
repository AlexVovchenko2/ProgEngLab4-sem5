...
namespace lab4
{
    ...
    public class Footballer
    {
        ...
        private string _club;          // ← новое поле: клуб
        ...
        public Footballer(string name, int age, string position, string club = "неизвестен")
        {
        ...
        {
            return $"{_name}, {_age} лет, позиция: {_position}, клуб: {_club}, голов: {_goalsScored}";
        }
        ...
        /// <exception cref="ArgumentOutOfRangeException">Выбрасывается, если count < 0.</exception>
